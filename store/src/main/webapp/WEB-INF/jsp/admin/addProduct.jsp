...
<h6><spring:message code="Product Details" text="Product Details" /></h6>
<div class="card">
  <div class="card-body">
    <div class="row">
...
<h6><spring:message code="Pricing" text="Pricing" /></h6>
<div class="card">
  <div class="card-body">
    <div class="row">
        <div class="col-md-10 mx-auto">
...
<div class="row spacer"></div>
<h6><spring:message code="Quantity" text="Quantity" /></h6>
<div class="card">
  <div class="card-body">
    <div class="row">
        <div class="col-md-10 mx-auto">
