       ...
       <form method="GET" class="form-horizontal" action="<%=RequestUrls.ROLES%>">
        <div class="row">
          <div class="col-sm-2 p-0">
            <spring:message code="User Name" text="User Name" var="label" />
            <input type="text" id="<%=FieldNames.NAME %>" name="<%=FieldNames.NAME %>" value="${param.name}" class="form-control" placeholder="${label}" />
          </div>
          <div class="col-sm-2 p-0">
            <spring:message code="Role Name" text="Role Name" var="label" />
            <input type="text" id="<%=FieldNames.ROLE_NAME %>" name="<%=FieldNames.ROLE_NAME %>" value="${param.roleName}" class="form-control" placeholder="${label}" />
          </div>
          <div class="col-sm-2 p-0">
