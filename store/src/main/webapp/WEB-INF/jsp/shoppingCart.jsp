...
<ol class="breadcrumb">
  <li class="breadcrumb-item"><i class="fa fa-shopping-cart" font-size="15px"></i>&nbsp;&nbsp;<a href="${contextPath}<%=RequestUrls.PRODUCT_ALL %>"><spring:message code="Products" text="Products" /></a></li>
