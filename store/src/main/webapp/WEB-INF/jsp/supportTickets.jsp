    ...
    <form method="GET" class="form-horizontal" action="<%=RequestUrls.SUPPORT_TICKETS%>">
      <div class="card">
        <div class="card-body main-center">
          <div class="row">
            <div class="col-sm-2">
              <label for="<%=FieldNames.TICKET_NUMBER %>"><spring:message code="Ticket Number" text="Ticket Number" /></label>
              <input type="text" id="<%=FieldNames.TICKET_NUMBER %>" name="<%=FieldNames.TICKET_NUMBER %>" value="${param.ticketNumber}" class="form-control input-sm" />
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-2">
              <label for="<%=FieldNames.ORDER_NUMBER %>"><spring:message code="Order Number" text="Order Number" /></label> 
              <input type="text" id="<%=FieldNames.ORDER_NUMBER %>" name="<%=FieldNames.ORDER_NUMBER %>" value="${param.orderNumber}" class="form-control input-sm" />
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-2">
              <label for="<%=FieldNames.STATUS %>"><spring:message code="Status" text="Status" /></label> 
              <select id="<%=FieldNames.STATUS %>" name="<%=FieldNames.STATUS %>" class="form-control input-sm">
