...
public class TemplateMapper {
	...
	public TemplateDto templateToTemplateDto(Template template) {
        ...
        templateDto.setOldSubject(template.getSubject());
        templateDto.setBody(template.getBody());
        templateDto.setIsDeletable(template.getIsDeletable());
        templateDto.setIsEditable(template.getIsEditable());
	...
	public Template templateDtoToTemplate(TemplateDto templateDto) {
        ...
        template.setIsDeletable(templateDto.getIsDeletable());
        template.setIsEditable(templateDto.getIsEditable());
